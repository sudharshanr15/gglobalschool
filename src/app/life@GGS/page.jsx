...
function page() {
    return (
        <>
            <Hero title={"LIFE @ GGS"} />
            <section className="section-container bg-primary-maroon">
                <p className=" text-heading-4 text-white uppercase ">
                    Teach your child the art of learning through
                    <span className=" "> creativity and curiosity.</span>
                </p>
            </section>

            {/* our facility */}
            <section className="section-container">
                <p className=" text-primary-maroon text-heading-6">
                    OUR FACILITIES
                </p>
                <p className=" pt-4 text-body">
                    Good infrastructure and facilities encourage kids to feel
                    warm and welcoming in the school. They also provide various
            ...
            {/* FIELD TRIPS */}
                <section className="section-container">
                    <p className=" py-2 text-primary-maroon text-heading-6">
                        FIELD TRIPS
                    </p>
