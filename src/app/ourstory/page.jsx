...
function page() {
    return (
        <>
                ...
                <div className="top-5 ">
                    <p className="text-heading-6">
                        ...
                        <span className="text-primary-maroon ">
                            {" "}
                            sparkling imaginations, fertile minds, and
                            willingness
                        </span>
            ...
            {/* about GGS */}
            <section className="section-container">
                <div className="w-full   flex flex-col md:flex-row gap-5 md:gap-xl">
                    ...
                    <div className="w-full md:w-[50%]">
                        ...
                        <div className=" text-left  md:w-[90%] flex flex-col  text-body pt-3 gap-3">
                            ...
                            <div className="top-auto text-body">
                                <p className="">
                                    We proudly introduced our new venture, the G
                                    Global School, a fresh breath of experience
                                    to
                                    <span className="font-bold">
                                    ...
                                    <span>
                                        , a prime location for educational
            ...
            {/* chairman director */}
            <section className="section-container">
                <p className="text-heading-4 uppercase  text-primary-maroon">
                    MANAGEMENT
                </p>
                <div className="w-full flex flex-col md:flex-row md:mt-2xl  gap-md md:gap-[42px]">
            ...
            <section>
                <div className="w-[90%] md:w-[95%] flex flex-col md:flex-row justify-center  mx-auto top-3 pt-xl md:p-xl gap-md md:gap-[30px]">
                    <div className=" p-md ">
                        ...
                        <p className=" pt-large text-subheading-regular ">
                            PYP COORDINATOR
                        </p>
                        <p className=" pt-md ">
