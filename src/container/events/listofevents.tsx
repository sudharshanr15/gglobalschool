...
const Listofevents = () => {
    const gallery_images: any = {
        ...
        "Parents Teachers Meeting": [
            ...Object.values(parents_teachers_meeting),
        ],
    ...
    return (
        <section className="section-container">
            <div>
              <h2 className="text-heading-4 text-primary-maroon mb-large">
                    DAYS AND EVENTS
                </h2>
                <p>
                    In GGS we celebrate special days and various events as they
                    are the sign of triumph over adversity, of strength and of
                    hope. We make our children thoughtful to understate purpose
                    of celebrating various days throughout the year.
                </p>
            </div>
            <div className="mt-xl md:mt-2xl">
              ...
              <div className="grid gap-md xl:gap-xl grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
