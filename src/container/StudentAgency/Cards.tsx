    ...
    <div className="w-full py-[1rem] px-md  bg-white ">
      <div className="w-full mx-auto md:px-32 grid md:grid-cols-3 gap-8 ">
        <div className="w-full  flex flex-col  my-4  ">
          <div className="text-left p-3xl rounded-[32px] font-medium bg-[#790000] text-[#737373]  ">
        ...
        <div className="w-full flex flex-col  my-4  ">
          <div className=" font-medium py-3 p-2xl sm:pb-8 rounded-[32px] bg-[#790000] text-[#737373]  ">
        ...
        <div className="w-full  flex flex-col  my-4  ">
          <div className="text-left font-medium py-3 p-xl  rounded-[32px] bg-[#790000] text-[#737373]  ">
