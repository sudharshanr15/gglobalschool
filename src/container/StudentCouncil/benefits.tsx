...
const Benefits = () => {
  return (
    <div className="lg:flex align-center justify-between mx-auto mb-20 mt-20">
      <div className="w-3/4 lg:w-1/2 m-10 lg:mx-20 mr-16 mt-0 flex-col justify-between">
        ...
        <Image src={benefitImage} className="lg:ml-16 lg:mr-20 h-full" alt="studentcouncil"/>
    </div>
  )
}
