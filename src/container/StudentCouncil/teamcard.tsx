...
const Teamcard = () => {
  return (
    <section className="lg:flex md:flex align-center gap-md md:gap-md justify-center md:my-3xl lg:my-3xl w-fit mx-md md:mx-auto lg:mx-auto">
      <div className="md:w-44 lg:w-56 px-md py-xl lg:py-2xl border border-primary-maroon my-md rounded-3xl">
