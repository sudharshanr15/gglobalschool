...
const Teamcard = () => {
  return (
    <div className="lg:flex md:flex align-center gap-5 md:gap-2 justify-center md:my-20 lg:my-20 w-fit mx-5 md:mx-auto lg:mx-auto">
      <div className="md:w-44 lg:w-56 px-4 py-10 lg:py-16 border border-primary-maroon my-5 rounded-3xl">
      ...
      <div className="md:w-44 lg:w-56 px-4 md:px-2 py-10 lg:py-16 border border-primary-maroon my-5 rounded-3xl">
