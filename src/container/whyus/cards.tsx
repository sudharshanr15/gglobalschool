...
const Cards = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mx-5 md:mx-20 lg:mx-20">
   ...
   <div className="w-[100%] lg:w-1/3 ease-in duration-500 hover:bg-primary-maroon grid md:grid-rows-3 md:hover:grid-rows-5 lg:grid-rows-3 hover:lg:grid-rows-5 hover:text-gray-100 mx-auto mx-5 lg:col-span-3">
        <div className="image-container w-[100%] h-72 md:h-full row-span-2 lg:h-full overflow-hidden">
            <div className="relative w-full h-full">
